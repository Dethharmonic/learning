export class CreepRole {
    public static readonly HARVESTER1: CreepRole = new CreepRole(1, 'HARVESTER1', [WORK, CARRY, MOVE]);
    public static readonly UPGRADER1: CreepRole = new CreepRole(2, 'UPGRADER1', [WORK, CARRY, MOVE]);
    public static readonly BUILDER1: CreepRole = new CreepRole(3, 'BUILDER1', [WORK, CARRY, MOVE]);
